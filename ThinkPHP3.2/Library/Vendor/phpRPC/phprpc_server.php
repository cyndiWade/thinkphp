...
class PHPRPC_Server {
    ...
    function initKey() {
        if ($this->encrypt == 0) {
            ...
            if (isset($session['key'])) {
                ...
                require_once('../../../../Library/xxtea.phpHP/Library/Vendor/phpRPC/xxtea.php');
                return;
            }
        }
        $this->errno = E_ERROR;
    ...
    function keyExchange() {
        require_once('../ThinkPHP/Library/Vendor/phpRPC/bigint.php./Library/bigint.php');
        $this->initKeylen();
        if (isset($_SESSION[$this->cid])) {
            $session = unserialize(base64_decode($_SESSION[$this->cid]));
        }
        else {
          ../../../../Library/dhparams.php array();
        }        
        if ($this->encrypt === true) {
      ../ThinkPHP/Library/Vendor/phpRPC/dhparams.phpe_once('dhparams.php');
  ...
  ../ThinkPHP/Library/Vendor/phpRPC/compat.phpire_once('../../../../Library/compat.php');
