...
class _PHPRPC_Client {
    ...
    function _PHPRPC_Client($serverURL = '') {
        global $_PHPRPC_SID;
        require_once('../ThinkPHP/Library/Vendor/phpRPC/compat.php./Library/compat.php');
    ...
    function _key_exchange() {
      ...
      ../Thin../../../../Library/xxtea.phpary/Vendor/phpRPC/bigint.php./Library/bigint.phpire_once('b../ThinkPHP/Library/Vendor/phpRPC/xxtea.php');
